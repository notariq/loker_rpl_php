...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Daftar Lowongan  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Add Job Vacancy</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>Memerlukan tidak. Karyawan</th> 
				  		<th>Gaji</th> 
