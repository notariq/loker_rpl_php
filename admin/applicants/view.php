...
<div class="col-sm-6 content-body" > 
	...
	<div class="col-sm-6">
		<ul>
            ...
            <li><i class="fa fa-sun-"></i>Durasi Pekerjaan: <?php echo $job->DURATION_EMPLOYEMENT; ?></li>
        </ul>
	</div> 
	<div class="col-sm-6">
		<ul> 
            <li><i class="fp-ht-tv"></i>Jenis kelamin : <?php echo $job->PREFEREDSEX; ?></li>
            <li><i class="fp-ht-computer"></i>Sektor Lowongan : <?php echo $job->SECTOR_VACANCY; ?></li>
        </ul>
	</div>
	<div class="col-sm-12">
		<p>Uraian Tugas : </p>   
...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		...
		<li>Alamat Address. : <?php echo $appl->EMAILADDRESS;?></li>
		<li>Jenis kelamin: <?php echo $appl->SEX;?></li>
		<li>Usia : <?php echo $appl->AGE;?></li> 
	</ul>
	<div class="col-sm-12"> 
		<p>Pencapaian Pendidikan: </p>
...
<p><i class="fa fa-paperclip"></i>  File Lampiran</p>
	<div class="col-sm-12 slider">
		 <h3>Unduh Lanjutkan <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">Here</a></h3>
	</div> 
