...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>aplikasi lowongan pekerjaan</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>aplikasi lowongan pekerjaan</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">Subscribe</a>.</strong> All rights
    reserved.
  </footer>
